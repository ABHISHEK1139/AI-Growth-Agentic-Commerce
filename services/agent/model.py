...
class MockModelProvider:
    ...
    def generate(
        ...
        *,
        ...
        category = None
        if any(
            k in p_lower for k in ["laptop", "ultrabook", "notebook", "macbook", "computer", "pc"]
        ):
            category = "laptop"
            ...
            k in p_lower
            for k in ["camera", "dslr", "lens", "optics", "cam", "gopro", "photo", "video"]
        ):
            category = "camera"
        elif any(
            k in p_lower
            ...
            k in p_lower
            for k in ["charger", "cable", "case", "cover", "magsafe", "adapter", "power bank"]
        ):
        ...
        budget_minor = (
            7000000
            if (
                "70000" in prompt or "70,000" in prompt or "under" in p_lower or "budget" in p_lower
            )
            else 25000000
        )
